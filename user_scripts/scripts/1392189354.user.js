...
// @grant       GM_info 
// @downloadURL   https://phoenix.arzhanov.trunk-web1.pmmedia.com.ua/1392189354.user.js
...
var newUICSS = GM_getResourceText ("uiStyle");
GM_addStyle (newUICSS);
...
{      
  ...
  {
    document.getElementsByClassName("frm-birthday")[0].childNodes[1].innerHTML ='10';
    setInputValue(document.getElementById('UserForm_month'), '10');  
  }
 
  if(document.getElementById('UserForm_day'))
  {
    document.getElementsByClassName("frm-birthday")[0].childNodes[1].innerHTML ='10';
    setInputValue(document.getElementById('UserForm_day'), '10');
  }

if(document.getElementById('screenname'))
{
  setInputValue(document.getElementById('screenname'), screenname);
}
else
{
  var inp = document.createElement('input');
  inp.setAttribute('id','funnel-form-user-screenname');
  inp.setAttribute('type','hidden');  
  inp.setAttribute('name','funnel-form-user-screenname');
